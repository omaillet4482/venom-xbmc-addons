...
SITE_IDENTIFIER = 'streamingsport_debug'
SITE_NAME = 'Streaming Sport DEBUG'
SITE_DESC = 'Site pour regarder du sport en direct gratuitement'

URL_MAIN = 'http://streaming-sport.tv'
URL_SEARCH = (URL_MAIN + '/frx/fanclubs/?q=', 'showMovies4')
FUNCTION_SEARCH = 'showMovies4'

SPORT_SPORTS = (URL_MAIN + '/chaine/', 'showMovies') #Les matchs en directs et chaines
...
def showMovies(sSearch = ''):#affiche les chaines
    ...
    sPattern = '<a href="([^"]+)"><img src="([^"]+/([a-z\+0-9]+)\.png)"'
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addDir(SITE_IDENTIFIER, 'showMovies2', sTitle, sIcon, oOutputParameterHandler)
